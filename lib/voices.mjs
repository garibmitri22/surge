...
export const VOICES = {
  ...
  aria: {
    name: 'Aria',
    character: 'warm, professional, personable — a real rep you’d want on the phone',
    // Matilda — warm, friendly, natural American female. Clean and pleasant, not robotic.
    // Override with ELEVENLABS_VOICE_ARIA to drop in an exact voice id from your ElevenLabs library.
    voiceId: env('ELEVENLABS_VOICE_ARIA', 'XrExE9yKIg1WjnnlVkGX'),
    settings: { stability: 0.55, similarity_boost: 0.8, style: 0.15, speed: 1.0, use_speaker_boost: true },
  },
  nova: {
    name: 'Nova',
