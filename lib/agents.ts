...
export const AGENTS: Record<string, AgentProfile> = {
  atlas: {
    ...
    does: [
      ...
      'Bring you decisions ready to make — options and a recommendation, never a raw problem.',
    ],
    cta: 'Talk to Atlas',
  },
  aria: {
  ...
  nova: {
    ...
    spokenIntro: "I'm Nova. I draft on-brand content and campaigns that sound like you — and keep your name in front of your market.",
    tagline: 'I draft on-brand content and campaigns that sound like you.',
    intro:
      "I keep your name in front of the customers Aria isn't talking to yet. I draft content and campaigns in your brand voice and bring you the hooks that are working — the marketing arm of your workforce.",
    does: [
      ...
      'Keep your brand showing up consistently, getting sharper every week.',
    ],
    cta: 'Hear Nova',
  },
  opus: {
