...
4. Cover what the site can't tell you, one at a time: ICP (who's ideal AND who's NOT), offer & pricing + the transformation it delivers, proof points (REAL only — if they have none yet, say that's fine and note it), brand voice (formal/casual + words to ban), the #1 goal for the next 90 days, and the brand kit (logo: they can upload or you take it from the site; primary colors — offer any detected; words/claims never to use).
